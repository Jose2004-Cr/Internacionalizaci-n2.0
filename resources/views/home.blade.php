    ...
    <body>
        <div class="container">
            <div class="flex items-center justify-between mb-6">
                ...
                <button id="addEventButton" class="px-4 py-2 text-white bg-blue-900 rounded shadow-md hover:bg-[#0F293E]">Agregar Evento
                    +</button>
            </div>
            <section>
                <main>
                ...
                <form id="eventForm">
                    ...
                    <div class="mb-4">
                        <label for="eventLocation" class="block mb-2 font-bold text-gray-700">Ubicación del
                            Evento</label>
                        <select id="eventLocation" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring focus:ring-blue-200">
                    ...
                    <div class="mb-4">
                        <label for="eventDescription" class="block mb-2 font-bold text-gray-700">Descripción del
                            Evento</label>
                        <textarea id="eventDescription" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring focus:ring-blue-200"></textarea>
                    </div>
                    <div class="flex justify-end">
                        ...
                        <button type="submit" class="px-4 py-2 text-white bg-blue-900  rounded hover:bg-[#0F293E]">Agregar Evento</button>
                    </div>
                </form>
            </div>
        </div>
